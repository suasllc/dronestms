...
var a = 'a very very long string to be squashed fdkj fdsfsdlfj 4324234l23 j 4329402348234 l;fsdf $#@$@#423 ljk4324jl';
var b = a.compress(); // 'a veryāăąlong striċ to bečquashed'
var c = b.decompress(); // 'a very very long string to be squashed'
console.log(a, b, c);
console.log(a === c); // True
var d = a.compress(true); // return as Array
console.log(d); // [97, 32, 118 .... 101, 100] an Array of ASCII codes